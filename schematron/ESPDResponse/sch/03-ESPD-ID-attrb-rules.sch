...
-->
	...
	<!-- Identifier Elements: EconomicOperator -->
	<rule context="espd-cbc:NationalDataBaseURIID">
		<!-- The attributes schemeAgencyID must be provided and filled in. -->
		<assert test="( not(string(@schemeAgencyID))=false() )">The attribute 'schemeAgencyID' is mandatory and must be provided and filled in </assert>
	</rule>
	...
	<rule context="cbc:CustomizationID">
		...
		<!-- Value must be 2.1 -->
		<assert test="( string(.)='urn:www.cenbii.eu:transaction:biitrns092:ver3.0' )">The value must be 'urn:www.cenbii.eu:transaction:biitrns092:ver3.0' </assert>
	</rule>
