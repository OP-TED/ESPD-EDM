...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <axsl:template
            match="cbc:TypeCode | ccv-cbc:JurisdictionLevelCode | cbc:ActivityTypeCode | cbc:LocaleCode | cbc:ContractTypeCode | cbc:CurrencyCode | cbc:ProcurementTypeCode | cbc:RoleCode"
            priority="1003" mode="M9">
