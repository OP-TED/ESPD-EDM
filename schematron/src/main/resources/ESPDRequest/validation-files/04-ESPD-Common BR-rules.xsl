...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <axsl:variable name="TypeCodeExclusion"
                   select="/espd-req:ESPDRequest/ccv:Criterion/cbc:TypeCode[starts-with(., 'CRITERION.EXCLUSION.')]"/>
    ...
    <axsl:template match="/espd-req:ESPDRequest/cac:ProcurementProjectLot" priority="1009" mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="( not(cbc:ID!='0') )">
                    ...
                    <svrl:text>The current version of the ESPD Service does not allow for the specification of multiple
                        lots. To ensure conformace with the current version of the ESPD Service the ID sub-element
                        inside the element ProcurementProjectLot MUST be 0 (zero).
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
    ...
    <axsl:template match="/espd-req:ESPDRequest" priority="1007" mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(cbc:IssueDate))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="count( cac:AdditionalDocumentReference ) &gt; 0">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
                    <svrl:text>The ESPDRequest MUST always contain one 'AdditionalDocumentReference' element referring
                        to the Contract Notice (CN) published in TeD (Publications Office).
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
    ...
    <axsl:template match="/espd-req:ESPDRequest/ccv:Criterion" priority="1006" mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(cbc:Name))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(cbc:Description))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(cbc:TypeCode))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            <axsl:when
                    test="not( (count(ccv:LegislationReference) = 0) and (contains(cbc:TypeCode, 'CRITERION.EXCLUSION.'))  )"/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="not( (count(ccv:LegislationReference) = 0) and (contains(cbc:TypeCode, 'CRITERION.EXCLUSION.')) )">
                    <axsl:attribute name="location">
                    ...
                    <svrl:text>All Exclusion Criteria MUST provide a value for the element LegislationReference
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
    ...
    <axsl:template match="/espd-req:ESPDRequest/ccv:Criterion/ccv:RequirementGroup" priority="1005" mode="M10">
    ...
    <axsl:template match="/espd-req:ESPDRequest/ccv:Criterion/ccv:RequirementGroup/ccv:Requirement" priority="1004"
                   mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(@responseDataType))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
    ...
    <axsl:template match="/espd-req:ESPDRequest/ccv:Criterion/ccv:LegislationReference" priority="1003" mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(ccv-cbc:Article))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(ccv-cbc:JurisdictionLevelCode))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(ccv-cbc:Title))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
    ...
    <axsl:template match="ccv:RequirementGroup/cbc:ID | ccv:RequirementGroup/ccv:Requirement/cbc:ID" priority="1002"
                   mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(@schemeAgencyID!='EU-COM-GROW') )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(@schemeID!='CriterionRelatedIDs') )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
    ...
    <axsl:template match="ccv:Criterion/cbc:ID" priority="1001" mode="M10">
    ...
    <axsl:template match="/espd-req:ESPDRequest/cac:AdditionalDocumentReference" priority="1000" mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="( not(string(cbc:ID))=false() )">
                    ...
                    <svrl:text>The AdditionalDocumentReference referring to the CN published in TeD MUST use the element
                        ID to identify the CN.
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
        ...
        <axsl:choose>
            <axsl:when
                    test="(count(cbc:ID)=0) or ( (count(cbc:ID))=1 and (string-length(cbc:ID)=17 and substring(cbc:ID,5,3)='/S ' and substring(cbc:ID,11,1)='-'))"/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="(count(cbc:ID)=0) or ( (count(cbc:ID))=1 and (string-length(cbc:ID)=17 and substring(cbc:ID,5,3)='/S ' and substring(cbc:ID,11,1)='-'))">
                    <axsl:attribute name="location">
                    ...
                    <svrl:text>The value of the ID MUST follow the pattern YYYY/S DDD-DDDDDD, where “YYYY” is a year,
                        “/S” is a constant label, and “D” represent digits. Beware of the existence of a space (a blank)
                        between the “S” and the first “D”.
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
