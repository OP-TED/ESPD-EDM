...
<!--VARIABLES-->
   ...
   <axsl:variable name="TypeCodeExclusion" select="/espd-req:ESPDRequest/ccv:Criterion/cbc:TypeCode[starts-with(., 'CRITERION.EXCLUSION.')]"/>
...
<!--PATTERN common-br-rules-->
   ...
   <axsl:template match="/espd-req:ESPDRequest/ccv:Criterion/ccv:RequirementGroup/ccv:Requirement" priority="1004" mode="M10">
   ...
   <axsl:template match="ccv:RequirementGroup/cbc:ID | ccv:RequirementGroup/ccv:Requirement/cbc:ID" priority="1002" mode="M10">
