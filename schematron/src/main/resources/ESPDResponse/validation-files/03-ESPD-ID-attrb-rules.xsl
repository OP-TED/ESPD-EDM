...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <axsl:template match="/">
        <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                title="Identifier elements - mandatory attributes" schemaVersion="">
            <axsl:comment>
    ...
    <axsl:template match="cbc:ID | cbc:UUID | cbc:VersionID | cbc:PreviousVersionID | cbc:ContractFolderID"
                   priority="1008" mode="M9">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( not(string(@schemeAgencyID))=false() )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
                    <svrl:text>The attribute 'schemeAgencyID' is mandatory and must be provided and filled in
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
    ...
    <axsl:template match="espd-cbc:NationalDataBaseURIID" priority="1007" mode="M9">
    ...
    <axsl:template match="cbc:LogoReferenceID | cbc:EndpointID | cbc:CompanyID | cbc:NationalityID | cbc:LanguageID"
                   priority="1005" mode="M9">
    ...
    <axsl:template
            match="cbc:ValidatorID | cbc:PaymentMeansID | cbc:PrepaidPaymentReferenceID | cbc:TenderEnvelopeID | cbc:OpenTenderID"
            priority="1004" mode="M9">
    ...
    <axsl:template match="cbc:UBLVersionID" priority="1003" mode="M9">
        ...
        <axsl:choose>
            <axsl:when test="( string(.)!='2.1' )"/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="( string(.)!='2.1' )">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
