...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <axsl:template match="/">
        <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                title="Code list elements - mandatory attributes" schemaVersion="">
            <axsl:comment>
    ...
    <axsl:template
            match="cbc:TypeCode | ccv-cbc:JurisdictionLevelCode | cbc:ActivityTypeCode | cbc:LocaleCode | espd-cbc:EconomicOperatorRoleCode"
            priority="1004" mode="M10">
        ...
        <axsl:choose>
            ...
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="@listID and @listAgencyID and @listVersionID">
                    <axsl:attribute name="location">
                        <axsl:apply-templates select="." mode="schematron-get-full-path"/>
                    </axsl:attribute>
                    <svrl:text>One or more of the mandatory attributes (listID, listAgengyID, listVersionID) are not
                        provided
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
    ...
    <axsl:template match="espd-cbc:NaturalPersonRoleCode | espd-cbc:NaturalPersonRegistrationCountryCode"
                   priority="1003" mode="M10">
    ...
    <axsl:template match="cbc:PartyTypeCode | cbc:AddressTypeCode | cbc:AddressFormatCode | cbc:CountrySubentityCode"
