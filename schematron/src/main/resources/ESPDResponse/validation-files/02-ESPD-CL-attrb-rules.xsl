...
<!--PATTERN cl-attrb-rules-->
   ...
   <axsl:template match="cbc:TypeCode | ccv-cbc:JurisdictionLevelCode | cbc:ActivityTypeCode | cbc:LocaleCode | espd-cbc:EconomicOperatorRoleCode" priority="1004" mode="M10">
   ...
   <axsl:template match="espd-cbc:NaturalPersonRoleCode | espd-cbc:NaturalPersonRegistrationCountryCode" priority="1003" mode="M10">
   ...
   <axsl:template match="ext:ExtensionReasonCode" priority="1002" mode="M10">
   ...
   <axsl:template match="cbc:PartyTypeCode | cbc:AddressTypeCode | cbc:AddressFormatCode | cbc:CountrySubentityCode" priority="1001" mode="M10">
