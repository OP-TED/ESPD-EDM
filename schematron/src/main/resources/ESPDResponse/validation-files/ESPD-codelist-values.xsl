...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <axsl:template match="cbc:TypeCode" priority="1011" mode="M0">
        ...
        <axsl:choose>
            <axsl:when
                    test="( false() or ( ( not(@listName!='CriteriaTypeCode') ) and ( not(@listID!='CriteriaTypeCode') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='DG GROW (European Commission)') ) and ( not(@listAgencyID!='EU-COM-GROW') ) and (contains(translate('CRITERION.OTHER.EO_DATA.SHELTERED_WORKSHOPCRITERION.OTHER.EO_DATA.REGISTERED_IN_OFFICIAL_LISTCRITERION.OTHER.EO_DATA.TOGETHER_WITH_OTHERSCRITERION.OTHER.EO_DATA.RELIES_ON_OTHER_CAPACITIESCRITERION.OTHER.EO_DATA.SUBCONTRACTS_WITH_THIRD_PARTIESCRITERION.OTHER.EO_DATA.MEETS_THE_OBJECTIVECRITERION.EXCLUSION.CONVICTIONS.PARTICIPATION_IN_CRIMINAL_ORGANISATIONCRITERION.EXCLUSION.CONVICTIONS.CORRUPTIONCRITERION.EXCLUSION.CONVICTIONS.FRAUDCRITERION.EXCLUSION.CONVICTIONS.TERRORIST_OFFENCESCRITERION.EXCLUSION.CONVICTIONS.MONEY_LAUNDERINGCRITERION.EXCLUSION.CONVICTIONS.CHILD_LABOUR-HUMAN_TRAFFICKINGCRITERION.EXCLUSION.CONTRIBUTIONS.PAYMENT_OF_TAXESCRITERION.EXCLUSION.CONTRIBUTIONS.PAYMENT_OF_SOCIAL_SECURITYCRITERION.EXCLUSION.SOCIAL.ENVIRONMENTAL_LAWCRITERION.EXCLUSION.SOCIAL.SOCIAL_LAWCRITERION.EXCLUSION.SOCIAL.LABOUR_LAWCRITERION.EXCLUSION.BUSINESS.BANKRUPTCYCRITERION.EXCLUSION.BUSINESS.INSOLVENCYCRITERION.EXCLUSION.BUSINESS.CREDITORS_ARRANGEMENTCRITERION.EXCLUSION.BUSINESS.BANKRUPTCY_ANALOGOUSCRITERION.EXCLUSION.BUSINESS.LIQUIDATOR_ADMINISTEREDCRITERION.EXCLUSION.BUSINESS.ACTIVITIES_SUSPENDEDCRITERION.EXCLUSION.MISCONDUCT.MC_PROFESSIONALCRITERION.EXCLUSION.MISCONDUCT.MARKET_DISTORTIONCRITERION.EXCLUSION.CONFLICT_OF_INTEREST.PROCEDURE_PARTICIPATIONCRITERION.EXCLUSION.CONFLICT_OF_INTEREST.PROCEDURE_PREPARATIONCRITERION.EXCLUSION.CONFLICT_OF_INTEREST.EARLY_TERMINATIONCRITERION.EXCLUSION.CONFLICT_OF_INTEREST.MISINTERPRETATIONCRITERION.EXCLUSION.NATIONAL.OTHERCRITERION.SELECTION.ALL_SATISFIEDCRITERION.SELECTION.SUITABILITY.PROFESSIONAL_REGISTER_ENROLMENTCRITERION.SELECTION.SUITABILITY.TRADE_REGISTER_ENROLMENTCRITERION.SELECTION.SUITABILITY.AUTHORISATIONCRITERION.SELECTION.SUITABILITY.MEMBERSHIPCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.GENERAL_YEARLYCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.AVERAGE_YEARLYCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.SPECIFIC_YEARLYCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.SPECIFIC_AVERAGECRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.SET_UPCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.FINANCIAL_RATIOCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.RISK_INDEMNITY_INSURANCE.PROFESIONALCRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.OTHER_REQUIREMENTSCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.REFERENCES.WORKS_PERFORMANCECRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.REFERENCES.SUPPLIES_DELIVERY_PERFORMANCECRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.REFERENCES.SERVICES_DELIVERY_PERFORMANCECRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.TECHNICIANS_FOR_QUALITY_CONTROLCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.TECHNICIANS_FOR_CARRYING_WORKSCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.FACILITIES_FOR_QUALITY_ENSURINGCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.FACILITIES_FOR_STUDY_RESEARCHCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.SUPPLY_CHAIN_MANAGEMENTCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.PROFESSIONAL_QUALIFICATIONSCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.ENVIRONMENTAL_MANAGEMENT_MEASURESCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.EQUIPMENTCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.TECHNICAL.CHECKS.CHECKS_ALLOWANCECRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.MANAGEMENT.MANAGERIAL_STAFFCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.MANAGEMENT.AVERAGE_ANNUAL_MANPOWERCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.MANAGEMENT.SUBCONTRACTING_PROPORTIONCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.MANAGEMENT.ARTEFACTS.NO_AUTHENTICATED_ARTEFACTSCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.MANAGEMENT.ARTEFACTS.AUTHENTICATED_ARTEFACTSCRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.CERTIFICATES.QUALITY_ASSURANCE.QA_INSTITUTES_CERTIFICATECRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.CERTIFICATES.QUALITY_ASSURANCE.QA_INDEPENDENT_CERTIFICATECRITERION.SELECTION.TECHNICAL_PROFESSIONAL_ABILITY.CERTIFICATES.ENVIRONMENTAL_MANAGEMENT.ENV_INDEPENDENT_CERTIFICATE','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                    ...
                    <svrl:text>Invalid value: '
                        <axsl:text/>
                        <axsl:value-of select="."/>
                        <axsl:text/>' for the element or invalid codelist used
                    </svrl:text>
                </svrl:failed-assert>
            </axsl:otherwise>
        </axsl:choose>
    ...
    <axsl:template match="@responseDataType" priority="1010" mode="M0">
        ...
        <axsl:choose>
            <axsl:when
                    test="( false() or ( (contains(translate('AMOUNTCODECODE_COUNTRYDATEDESCRIPTIONEVIDENCE_URLINDICATORPERCENTAGEPERIODQUANTITY_INTEGERQUANTITY_YEARQUANTITY','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( false() or ( (contains(translate('AMOUNTCODECODE_COUNTRYDATEDESCRIPTIONEVIDENCE_URLINDICATORPERCENTAGEPERIODQUANTITY_INTEGERQUANTITY_YEARQUANTITY','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
                    <axsl:attribute name="location">
    ...
    <axsl:template match="ccv-cbc:JurisdictionLevelCode" priority="1007" mode="M0">
        ...
        <axsl:choose>
            <axsl:when
                    test="( false() or ( ( not(@listName!='CriterionJurisdictionLevel') ) and ( not(@listID!='CriterionJurisdictionLevel') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='DG GROW (European Commission)') ) and ( not(@listAgencyID!='EU-COM-GROW') ) and (contains(translate('EU_REGULATIONEU_DIRECTIVEEU_DECISIONNATIONAL_LEGISLATIONSUBNATIONAL_LEGISLATION','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( false() or ( ( not(@listName!='CriterionJurisdictionLevel') ) and ( not(@listID!='CriterionJurisdictionLevel') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='DG GROW (European Commission)') ) and ( not(@listAgencyID!='EU-COM-GROW') ) and (contains(translate('EU_REGULATIONEU_DIRECTIVEEU_DECISIONNATIONAL_LEGISLATIONSUBNATIONAL_LEGISLATION','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
                    <axsl:attribute name="location">
    ...
    <axsl:template match="cbc:ContractTypeCode" priority="1004" mode="M0">
        ...
        <axsl:choose>
            <axsl:when
                    test="( false() or ( ( not(@listName!='ContractType') ) and ( not(@listID!='ContractType') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='BII') ) and ( not(@listAgencyID!='') ) and (contains(translate('12345678','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( false() or ( ( not(@listName!='ContractType') ) and ( not(@listID!='ContractType') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='BII') ) and ( not(@listAgencyID!='') ) and (contains(translate('12345678','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
                    <axsl:attribute name="location">
    ...
    <axsl:template match="cac:Country/cbc:IdentificationCode" priority="1003" mode="M0">

        <!--ASSERT -->

        <axsl:choose>
            <axsl:when
                    test="( false() or ( ( not(@listName!='CountryCodeIdentifier') ) and ( not(@listID!='CountryCodeIdentifier') ) and ( not(@listVersionID!='ISO 3166-1 2A:2006') ) and ( not(@listSchemeURI!='http://www.unece.org/fileadmin/DAM/uncefact/identifierlist/standard/ISO_ISOTwoletterCountryCode_SecondEdition2006VI-12.xsd') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='ISO') ) and ( not(@listAgencyID!='ISO') ) and (contains(translate('ADAEAFAGAIALAMAOAQARASATAUAWAXAZBABBBDBEBFBGBHBIBJBLBMBNBOBQBRBSBTBVBWBYBZCACCCDCFCGCHCICKCLCMCNCOCRCUCVCWCXCYCZDEDJDKDMDODZECEEEGEHERESETFIFJFKFMFOFRGAGBGDGEGFGGGHGIGLGMGNGPGQGRGSGTGUGWGYHKHMHNHRHTHUIDIEILIMINIOIQIRISITJEJMJOJPKEKGKHKIKMKNKPKRKWKYKZLALBLCLILKLRLSLTLULVLYMAMCMDMEMFMGMHMKMLMMMNMOMPMQMRMSMTMUMVMWMXMYMZNANCNENFNGNINLNONPNRNUNZOMPAPEPFPGPHPKPLPMPNPRPSPTPWPYQARERORSRURWSASBSCSDSESGSHSISJSKSLSMSNSOSRSSSTSVSXSYSZTCTDTFTGTHTJTKTLTMTNTOTRTTTVTWTZUAUGUMUSUYUZVAVCVEVGVIVNVUWFWSYEYTZAZMZW','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( false() or ( ( not(@listName!='CountryCodeIdentifier') ) and ( not(@listID!='CountryCodeIdentifier') ) and ( not(@listVersionID!='ISO 3166-1 2A:2006') ) and ( not(@listSchemeURI!='http://www.unece.org/fileadmin/DAM/uncefact/identifierlist/standard/ISO_ISOTwoletterCountryCode_SecondEdition2006VI-12.xsd') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='ISO') ) and ( not(@listAgencyID!='ISO') ) and (contains(translate('ADAEAFAGAIALAMAOAQARASATAUAWAXAZBABBBDBEBFBGBHBIBJBLBMBNBOBQBRBSBTBVBWBYBZCACCCDCFCGCHCICKCLCMCNCOCRCUCVCWCXCYCZDEDJDKDMDODZECEEEGEHERESETFIFJFKFMFOFRGAGBGDGEGFGGGHGIGLGMGNGPGQGRGSGTGUGWGYHKHMHNHRHTHUIDIEILIMINIOIQIRISITJEJMJOJPKEKGKHKIKMKNKPKRKWKYKZLALBLCLILKLRLSLTLULVLYMAMCMDMEMFMGMHMKMLMMMNMOMPMQMRMSMTMUMVMWMXMYMZNANCNENFNGNINLNONPNRNUNZOMPAPEPFPGPHPKPLPMPNPRPSPTPWPYQARERORSRURWSASBSCSDSESGSHSISJSKSLSMSNSOSRSSSTSVSXSYSZTCTDTFTGTHTJTKTLTMTNTOTRTTTVTWTZUAUGUMUSUYUZVAVCVEVGVIVNVUWFWSYEYTZAZMZW','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
                    <axsl:attribute name="location">
    ...
    <axsl:template match="cbc:CurrencyCode" priority="1002" mode="M0">

        <!--ASSERT -->

        <axsl:choose>
            <axsl:when
                    test="( false() or ( ( not(@listName!='CurrencyCode') ) and ( not(@listID!='CurrencyCode') ) and ( not(@listVersionID!='ISO 4217 3A:2015') ) and ( not(@listSchemeURI!='http://www.unece.org/fileadmin/DAM/uncefact/codelist/standard/ISO_ISO3AlphaCurrencyCode_20120112.xsd') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='ISO') ) and ( not(@listAgencyID!='ISO') ) and (contains(translate('AEDAFNALLAMDANGAOAARSAUDAWGAZNBAMBBDBDTBGNBHDBIFBMDBNDBOBBOVBRLBSDBTNBWPBYRBZDCADCDFCHECHFCHWCLFCLPCNYCOPCOUCRCCUPCVECYPCZKDJFDKKDOPDZDEEKEGPERNETBEURFJDFKPGBPGELGHSGIPGMDGNFGTQGYDHKDHNLHRKHTGHUFIDRILSINRIQDIRRISKJMDJODJPYKESKGSKHRKMFKPWKRWKWDKYDKZTLAKLBPLKRLRDLSLLTLLVLLYDMADMDLMGAMKDMMKMNTMOPMROMTLMURMVRMWKMXNMXVMYRMZNNADNGNNIONOKNPRNZDOMRPABPENPGKPHPPKRPLNPYGQARRONRSDRUBRWFSARSBDSCRSDGSEKSGDSHPSKKSLLSOSSRDSTDSYPSZLTHBTJSTMMTNDTOPTRYTTDTWDTZSUAHUGXUSDUSNUSSUYUUZSVEBVNDVUVWSTXAFXAGXAUXBAXBBXBCXBDXCDXDRXFOXFUXOFXPDXPFXPTXTSXXXYERZARZMKZWD','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( false() or ( ( not(@listName!='CurrencyCode') ) and ( not(@listID!='CurrencyCode') ) and ( not(@listVersionID!='ISO 4217 3A:2015') ) and ( not(@listSchemeURI!='http://www.unece.org/fileadmin/DAM/uncefact/codelist/standard/ISO_ISO3AlphaCurrencyCode_20120112.xsd') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='ISO') ) and ( not(@listAgencyID!='ISO') ) and (contains(translate('AEDAFNALLAMDANGAOAARSAUDAWGAZNBAMBBDBDTBGNBHDBIFBMDBNDBOBBOVBRLBSDBTNBWPBYRBZDCADCDFCHECHFCHWCLFCLPCNYCOPCOUCRCCUPCVECYPCZKDJFDKKDOPDZDEEKEGPERNETBEURFJDFKPGBPGELGHSGIPGMDGNFGTQGYDHKDHNLHRKHTGHUFIDRILSINRIQDIRRISKJMDJODJPYKESKGSKHRKMFKPWKRWKWDKYDKZTLAKLBPLKRLRDLSLLTLLVLLYDMADMDLMGAMKDMMKMNTMOPMROMTLMURMVRMWKMXNMXVMYRMZNNADNGNNIONOKNPRNZDOMRPABPENPGKPHPPKRPLNPYGQARRONRSDRUBRWFSARSBDSCRSDGSEKSGDSHPSKKSLLSOSSRDSTDSYPSZLTHBTJSTMMTNDTOPTRYTTDTWDTZSUAHUGXUSDUSNUSSUYUUZSVEBVNDVUVWSTXAFXAGXAUXBAXBBXBCXBDXCDXDRXFOXFUXOFXPDXPFXPTXTSXXXYERZARZMKZWD','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
                    <axsl:attribute name="location">
    ...
    <axsl:template match="espd-cbc:EconomicOperatorRoleCode" priority="1000" mode="M0">
        ...
        <axsl:choose>
            <axsl:when
                    test="( false() or ( ( not(@listName!='TendererRole') ) and ( not(@listID!='TendererRole') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='BII') ) and ( not(@listAgencyID!='BII') ) and (contains(translate('MTSCCLCMJVSMEOTH','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) "/>
            <axsl:otherwise>
                <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                    test="( false() or ( ( not(@listName!='TendererRole') ) and ( not(@listID!='TendererRole') ) and ( not(@listVersionID!='1.0') ) and ( not(@listSchemeURI!='') ) and ( not(@listURI!='Placeholder') ) and ( not(@listAgencyName!='BII') ) and ( not(@listAgencyID!='BII') ) and (contains(translate('MTSCCLCMJVSMEOTH','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
                    <axsl:attribute name="location">
