...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="createRootElements">
		...
		<cbc:ProcedureCode listID="ProcedureType" listAgencyID="OP" listVersionID="3.2.0">AWARD_WO_PUB</cbc:ProcedureCode>
		...
		<cbc:QualificationApplicationTypeCode listID="QualificationApplicationType"	listAgencyID="OP" listVersionID="3.2.0">Basic</cbc:QualificationApplicationTypeCode>
	</xsl:template> 
