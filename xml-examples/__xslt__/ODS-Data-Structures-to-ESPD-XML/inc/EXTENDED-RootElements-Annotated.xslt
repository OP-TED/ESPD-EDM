...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template name="createRootElements">
		...
		<cbc:QualificationApplicationTypeCode listID="QualificationApplicationType" listAgencyID="OP" listVersionID="3.1.0">Extended</cbc:QualificationApplicationTypeCode>
	</xsl:template> 
