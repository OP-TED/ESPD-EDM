...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template name="createRootElements">
		<xsl:text disable-output-escaping="yes">&lt;</xsl:text>!-- T <xsl:text disable-output-escaping="yes"> ESPD-EDM-V3.2.0 is entirely based on OASIS UBL-2.3 </xsl:text> --<xsl:text disable-output-escaping="yes">&gt;</xsl:text>
		<cbc:UBLVersionID schemeAgencyID="OASIS-UBL-TC">2.2</cbc:UBLVersionID>
		<xsl:text disable-output-escaping="yes">&lt;</xsl:text>!-- How ESPD-EDM-V3.2.0 uses the UBL-2.3 schemas whilst keeping conformance --<xsl:text disable-output-escaping="yes">&gt;</xsl:text>
		<cbc:CustomizationID schemeAgencyID="OP" schemeVersionID="3.2.0">ESPD-3.2.0</cbc:CustomizationID>
		<cbc:ProfileID schemeAgencyID="OP" schemeVersionID="3.2.0">
		...
		<cbc:ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP"
			schemeAgencyName="Office des Publications - European Commission" schemeVersionID="3.2.0">
		...
		<cbc:VersionID schemeAgencyID="OP" schemeVersionID="3.2.0">1.0</cbc:VersionID>
		...
		<cbc:ProcedureCode listID="Dummy_procurement-procedure-type" listAgencyName="OP" listVersionID="3.2.0">open</cbc:ProcedureCode>
	</xsl:template> 
