...
<xsl:stylesheet version="2.0" 
	...
	xmlns:espd="urn:com:grow:espd:3.3.0" 
	...
	<xsl:template name="createRootElements">
		<xsl:text disable-output-escaping="yes">&lt;</xsl:text>!-- T <xsl:text disable-output-escaping="yes"> ESPD-EDM-V3.3.0 is entirely based on OASIS UBL-2.3 </xsl:text> --<xsl:text disable-output-escaping="yes">&gt;</xsl:text>
		...
		<cbc:CustomizationID schemeAgencyID="OP" schemeVersionID="3.3.0">ESPD-3.3.0</cbc:CustomizationID>
		<cbc:ProfileID schemeAgencyID="OP" schemeVersionID="3.3.0">
		...
		<cbc:ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP"
			schemeAgencyName="Office des Publications - European Commission" schemeVersionID="3.3.0">
