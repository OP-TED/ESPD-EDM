...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template name="createRootElements">
		<xsl:text disable-output-escaping="yes">&lt;</xsl:text>!-- T <xsl:text disable-output-escaping="yes"> ESPD-EDM-V2.1.1 is entirely based on OASIS UBL-2.2 </xsl:text> --<xsl:text disable-output-escaping="yes">&gt;</xsl:text>
		...
		<cbc:CustomizationID schemeAgencyID="OP" schemeVersionID="3.1.0">ESPD-2.1.1</cbc:CustomizationID>
