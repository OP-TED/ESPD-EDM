...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template name="createRootElements">
		<xsl:text disable-output-escaping="yes">&lt;</xsl:text>!-- The ESPD-EDM-V3.2.0 is entirely based on OASIS UBL-2.3 --<xsl:text disable-output-escaping="yes">&gt;</xsl:text> 
		...
		<cbc:ProfileExecutionID schemeAgencyID="OP" schemeVersionID="3.2.0">ESPD-EDMv3.2.0</cbc:ProfileExecutionID>
		...
		<cbc:VersionID schemeAgencyID="OP" schemeVersionID="3.2.0">3.2.0</cbc:VersionID>
		...
		<cbc:ProcedureCode listID="Dummy_procurement-procedure-type" listAgencyID="OP" listVersionID="3.2.0">Open</cbc:ProcedureCode>
	</xsl:template> 
