...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template name="createRootElements">
		...
		<cbc:ProfileExecutionID schemeAgencyID="OP" schemeVersionID="3.3.0">ESPD-EDMv3.3.0</cbc:ProfileExecutionID>
		...
		<cbc:VersionID schemeAgencyID="OP" schemeVersionID="3.3.0">3.3.0</cbc:VersionID>
