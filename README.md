...
* v2.0.2 (documentation in progress)
...
* **Version 2.0.2** (Feb. 2018): 

XML Validation: Schematron files for the validation of ESPD-EDM v2.0.1 REGULATED XML instances have been published in folder "dist/val". Beware that this development is an ongoing work, as per February 2018. The OASIS Genericode files have been moved from the "dist/cl/" folder into the "dist/val/schematron/common/" folder.
