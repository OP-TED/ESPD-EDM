...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:espd="urn:com:grow:espd:02.00.00" xmlns:cac="urn:X-test:UBL:Pre-award:CommonAggregate" xmlns:cbc="urn:X-test:UBL:Pre-award:CommonBasic" xmlns:util="java:java.util.UUID">
	...
	<xsl:template match="office:spreadsheet/table:table">
		<xsl:if test="@table:name='SC-Setup_of_economic_operator'">
	...
	<xsl:template name="createID">
		<xsl:variable name="uuid" select="ancestor::table:table-row/table:table-cell[13]/text:p"/>
		<!--xsl:if test="$uuid != '.'"-->
		<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">
	...
	<xsl:template name="createTypeCode">
		<xsl:variable name="code" select="ancestor::table:table-row/table:table-cell[14]/text:p"/>
		<!--xsl:if test="$code != '.'"-->
	...
	<xsl:template name="createDescription">
		<xsl:variable name="description" select="ancestor::table:table-row/table:table-cell[9]/text:p"/>
	...
	<xsl:template name="createName">
		<xsl:variable name="name" select="ancestor::table:table-row/table:table-cell[8]/text:p"/>
	...
	<xsl:template name="createCriterion">
		...
		<xsl:value-of select="ancestor::table:table-row/table:table-cell[8]/text:p"/>
	...
	<xsl:template name="createDataTypeValue">
		<xsl:variable name="dataValue" select="ancestor::table:table-row/table:table-cell[12]/text:p"/>
	...
	<xsl:template name="createExpectedRequirementValue">
		<xsl:for-each select="ancestor-or-self::table:table-row/table:table-cell">
			<xsl:if test="text:p = '{REQUIREMENT}'">
				...
				<xsl:variable name="propertyDataType" select="ancestor::table:table-row/table:table-cell[12]/text:p"/>
				<xsl:variable name="value" select="ancestor::table:table-row/table:table-cell[10]/text:p"/>
				<xsl:choose>
	...
	<xsl:template name="createProperty">
		<xsl:variable name="expectedValue" select="ancestor::table:table-row/table:table-cell[10]/text:p"/>
