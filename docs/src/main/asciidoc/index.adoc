...
* link:++https://espd.github.io/ESPD-EDM/v2.1.0/xml_guide.html++[ESPD Exchange Data Model Implementation Guide V2.1.0]
* link:++https://github.com/ESPD/ESPD-EDM/tree/2.1.0/docs/src/main/asciidoc/dist++[All resources in the distribution package]
* link:++https://espd.github.io/ESPD-EDM/v2.1.0/release_notes.html++[Release Notes]
