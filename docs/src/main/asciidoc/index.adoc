...
* link:https://espd-edm.github.io/xml_guide.html[ESPD Exchange Data Model Implementation Guide V2.1.1]
* link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist[All resources in the distribution package]
* link:https://espd-edm.github.io/ESPD-EDM/v2.1.1/release_notes.html[Release Notes]
