		...
		<cac:SubsidiaryTenderingCriterionPropertyGroup>
			...
			<cac:SubsidiaryTenderingCriterionPropertyGroup>
				...
				<cac:SubsidiaryTenderingCriterionPropertyGroup>
					...
					<cbc:PropertyGroupTypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="2.0.2">ONFALSE</cbc:PropertyGroupTypeCode> <--12--> 
					<cac:TenderingCriterionProperty>
...
<13> For the expected values in  the `cbc:ValueDataTypeCode` element please see the link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[Code List 'ResponseDataType'].s
