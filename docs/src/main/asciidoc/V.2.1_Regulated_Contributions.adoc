	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cac:SubsidiaryTenderingCriterionPropertyGroup>
			...
			<cac:TenderingCriterionProperty>
				...
				<cbc:Name/>
				<cbc:Description>URL</cbc:Description><--6-->
				<cbc:TypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">QUESTION</cbc:TypeCode>
			...
			<cac:TenderingCriterionProperty>
				...
				<cbc:Name/>
				<cbc:Description>Verification code</cbc:Description> <--7-->
				<cbc:TypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">QUESTION</cbc:TypeCode>
				<cbc:ValueDataTypeCode listID="ResponseDataType" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">DESCRIPTION</cbc:ValueDataTypeCode>
			</cac:TenderingCriterionProperty>
			<cac:TenderingCriterionProperty>
				...
				<cbc:Name/>
				<cbc:Description>Issuer</cbc:Description> <--8-->
				<cbc:TypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">QUESTION</cbc:TypeCode>
				<cbc:ValueDataTypeCode listID="ResponseDataType" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">DESCRIPTION</cbc:ValueDataTypeCode> <--13-->
			</cac:TenderingCriterionProperty>
		</cac:SubsidiaryTenderingCriterionPropertyGroup>
	</cac:TenderingCriterionPropertyGroup>
</cac:TenderingCriterion>
...
<6> URL from where to download the evidence.
<7> Reference number of verification code for the evidence.
<8> Data (e.g. the name) of the evidence issuer.
