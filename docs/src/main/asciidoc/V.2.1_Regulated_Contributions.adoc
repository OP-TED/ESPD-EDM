...
For a better understanding of the behavior of the Regulated 'Contributions' have a look to the two figures below. The first   one shows the GUI implemented by the EC ESPD Service for the contracting authority (which works only with the previous ESPD V1.0.2). The second and third ones show the GUI perspective for the economic operator:
