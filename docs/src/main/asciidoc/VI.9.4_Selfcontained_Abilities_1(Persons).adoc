...
=== VI.9.4 Self-contained Abilities (I) - Persons
...
.Self-contained 'Abilities (I)(Persons)' criterion data structure
image::Selfcontained_Abilities_1_Data_Structure.png[Self-contained 'Abilities (I) (Persons)' criterion data structure, alt="Self-contained 'Abilities (I)' ",align="center"]

==== XML Example - Self-contained (WEIGHTED)

The XML example below shows the REQUIREMENT(s) and QUESTION(s). See the section "link:#viii-3-xml-example-3-weighting[VIII.3. XML Example 3: Weighting]" for this same example followed by the responses.
...
. The data structure (see the SELF-CONTAINED spread-sheet tab link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.ods[SC-Abilities_1]).
