...
image:General_Yearly Turnovers_CA mock-up_ common_threshold.png[General Yearly Turnovers CA mock-up for common threshold,width=564,height=210]

_Figure 106. 'General Yearly Turnovers' CA mock-up for a a common threshold for all years requested._

image:General_Yearly_Turnovers_CA mock-up_ commonThreshold.png[General Yearly Turnovers CA mock-up for a a common threshold for all years requested,width=522,height=237]
...
image:average_yearly_turnover_CA_mockup.png['average yearly turnover' CA mock-up,width=623,height=180]
...
image:Specificyaer_turnoever_CA-perspective.png[specific yearly turnover' CA mock-up_,width=494,height=182]
...
image:Spec-aver-year-turn-CA.png[‘Specific average turnover' CA mock-up,width=566,height=209]
