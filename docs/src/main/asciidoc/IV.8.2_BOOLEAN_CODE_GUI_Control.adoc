...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.xlsx[ESPD-SELF-CONTAINED Criteria Taxonomy] spread-sheet).
