...
See formal requirements related to the contracting authorities in the e-Sens site: http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+European+Single+Procurement+Document#BIS41-EuropeanSingleProcurementDocument-tbr070-001[_tbr070-001_]*
