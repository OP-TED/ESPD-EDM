...
image:cacTenderingCriterionProperty_XSD_Schema.jpeg[cac:TenderingCriterionProperty - XSD Schema,width=227,height=710]

_Figure 38. cac:TenderingCriterionProperty - XSD Schema_

*Notice that*: One sub-criterion 'is a' criterion:

image:cacSubTenderingCriterion_XSD_Schema.jpeg[cac:SubTenderingCriterion- XSD Schema,width=544,height=147]
