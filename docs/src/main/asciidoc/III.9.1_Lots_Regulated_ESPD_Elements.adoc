...
*Rule*: Compulsory use of schemeAgencyID attribute. Check that the type of the `cbc:QualificationApplicationResponse` element is set to `REGULATED`. If more than one lot is present in the XML instance a warning should be thrown.
