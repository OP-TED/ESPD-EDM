...
----
|*MANDATORY* (1..1) 
|`*Rule*: Compulsory use of the UUIDs from the table link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[Criteria]`
...
----
|*MANDATORY* (1..1) 
|`*Rule*: Compulsory use of the code list link:.\code_lists_v1.0.2\PDF\EPROC-CriteriaTypeCode-060716-0945-12-v1.0.2.pdf[CriteriaTypeCode]`
...
----
|*MANDATORY* (1..1)
|`*Comment*: The names of the criteria can be obtained from the table link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[Criteria]`  
...
----
|*MANDATORY* (1..1) 
|`*Comment*: The descriptions of the criteria can be obtained from the table link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[Criteria]`  
...
link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[EU Exclusion Criteria]`  
