...
image:General_Yearly Turnovers_CA mock-up_ common_threshold.png[General Yearly Turnovers buyer mock-up for common threshold,width=564,height=210]

_Figure 106. 'General Yearly Turnovers' buyer mock-up for a a common threshold for all years requested._

image:General_Yearly_Turnovers_CA mock-up_ commonThreshold.png[General Yearly Turnovers buyer mock-up for a a common threshold for all years requested,width=522,height=237]

_Figure 107. 'General Yearly Turnovers' Buyer mock-up when applaying different turnover per year requested._

==== Mock-up - economic operator perspective

image:General_Specific_Yearly_Turnovers_ EO_mock-up.png['General and Specific Yearly Turnovers' EO mock-up_EO,width=612,height=230]
...
image:General_Yearly_Turnovers_criterion_data_structure.png['General Yearly Turnovers' criterion data structure,width=566,height=448]
...
image:average_yearly_turnover_CA_mockup.png['average yearly turnover' buyer mock-up,width=623,height=180]
...
image:Average_yearly turnover_EO_mockup.png['Average yearly turnover' EO mock-up_EO,width=555,height=229]

_Figure 113. ‘Average yearly turnover' EO mock-up_

==== Data Structure

image:Average_yearly turnover_criterion_data_structure.png[‘Average yearly turnover' criterion data structure,width=522,height=427]
...
image:Specificyaer_turnoever_CA-perspective.png[specific yearly turnover' buyer mock-up_,width=494,height=182]
...
image:EO-Specific-year-turn.png['specific yearly turnover' EO mock-up,width=506,height=423]
...
image:Specific_yearly turnover_criterion_data_structure.png[‘Specific yearly turnover' criterion data structure,width=509,height=403]
...
image:Spec-aver-year-turn-CA.png[‘Specific average turnover' buyer mock-up,width=566,height=209]

_Figure 124. ‘Specific average turnover' Buyer mock-up_

==== Mock-up - economic operator perspective

image:spec-aver-year-turn-EO.png[‘Specific average turnover' EO mock-up,width=566,height=204]
...
image:Specific_average turnover_criterion_data_structure.png[Specific average turnover' criterion data structure,width=566,height=450]
