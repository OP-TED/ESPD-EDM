...
http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+European+Single+Procurement+Document#BIS41-EuropeanSingleProcurementDocument-HighLevelBusinessRequirements[_tbr092-015_], http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+European+Single+Procurement+Document#BIS41-EuropeanSingleProcurementDocument-HighLevelBusinessRequirements[_br41-002_]
...
|===
*REQUIREMENT*
http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+European+Single+Procurement+Document#BIS41-EuropeanSingleProcurementDocument-tbr070-009[_tbr070-009_]
...
NOTE: As far as the _data structures_ of exclusion  criteria are concerned *there are not differences* between a Regulated ESPD and a Self-contained ESPD. 

The only difference lies in the way the criteria are worded; e.g. the description of a conviction criterion reads like this in the two cases:
...
image::ExclusionCriteriaTaxonomy.png[Exclusion criteria taxonomy, alt="Exclusion criteria taxonomy", width="600" align="center"]
