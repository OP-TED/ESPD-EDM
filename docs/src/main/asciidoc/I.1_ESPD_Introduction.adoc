...
For implementation purposes, please see the https://espd.github.io/ESPD-EDM/v3.0.0/xml_technical_handbook.html[ESPD Technical HandBook] , which is focused on providing technical guidance for the implementation of the ESPD Exchange Data Model (henceforth ESPD-EDM).
