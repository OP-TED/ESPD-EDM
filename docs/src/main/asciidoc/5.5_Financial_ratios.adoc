...
image:Financial ratio_CA mockup.png['Financial ratio' buyer mock-up,width=623,height=137]
...
image:Financial_ratio_EO_mock-up.png[‘Financial ratio' EO mock-up,width=454,height=279]
...
image:Financial_ratio_criterion_data_structure.png[‘Financial ratio' criterion data structure,width=526,height=293]
