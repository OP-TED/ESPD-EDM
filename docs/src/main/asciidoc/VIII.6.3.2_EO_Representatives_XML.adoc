		...
		<cac:AgentParty>
			<cac:Person>
				...
				<cac:ResidenceAddress>
					...
					<cac:Country>
						<cbc:IdentificationCode listID="CountryCodeIdentifier" listAgencyID="EU-COM-GROW" listVersionID="2.1.0">>BE</cbc:IdentificationCode><--6-->
		...
		<cac:AgentParty>
			<cac:Person>
				...
				<cac:ResidenceAddress>
					...
					<cac:Country>
						<cbc:IdentificationCode listID="CountryCodeIdentifier" listAgencyID="EU-COM-GROW" listVersionID="2.1.0">>ES</cbc:IdentificationCode>
