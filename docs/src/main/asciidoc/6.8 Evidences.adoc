...
image:cacEvidence_XSD_diagram.png[cac:Evidence XSD diagram,width=403,height=339]
...
image:cacDocumentReference_inside cacEvidence_XSD_diagram.png[cac:DocumentReference inside cac:Evidence XSD diagram,width=566,height=316]
...
image:Conviction_Participation_criminal organisation_mockup_EO.png[Conviction EO mock-up,width=537,height=440]
...
|*cbc:CandidateStatement* |Text |0..1 |Information about a candidate statement that the contracting authority accepts as a sufficient response. a|
*Information Requirement*: http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#BIS41-ESPDV2.1-tbr092-017[_tbr092-017, tbr092-007, tbr092-006_]
...
[source,xml]
----
_<!-- ANSWERS TO QUESTION(s) -->_

_<!-- ... elements removed for brevity .. -->_

_<!-- Answer to Criterion:Participation in a criminal organisation -->_

_<!-- Property:Evidence Supplied (PropertyID:d8d5478e-cc65-48c9-a189-19bbe87a9bfd) -->_
...
_<!-- Answer to Criterion:Contributions certificates -->_

_<!-- Property:URL (PropertyID:191b34a8-5af0-4d53-b431-4ecd624218ea) -->_
...
<cbc:ConfidentialityLevelCode listID="ConfidentialityLevel" listAgencyID="EU-COM-GROW" listVersionID=“3.0.0”>CONFIDENTIAL</cbc:ConfidentialityLevelCode> <5>
...
_<!-- Verification code to access an authentic 'manifestation' of the document from the original issuer end-point -->_
