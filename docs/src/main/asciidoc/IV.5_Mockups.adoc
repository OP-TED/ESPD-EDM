...
** ESPD-CriteriaTaxonomy-REGULATED-V2.1.1.xlsx, where the structures of the REGULATED ESPD criteria are defined;

** ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.xlsx, where the structures of the SELF-CONTAINE ESPD criteria are defined;
