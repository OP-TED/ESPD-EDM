...
of externalised codes. If you need the Genericode files you can download them altogheter, jointly with the code lists PDF files, from this link:.\code_lists_v1.0.2\code_lists_1.0.2.zip[zip volum]. 
====