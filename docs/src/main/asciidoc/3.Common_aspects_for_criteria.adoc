...
include::3.1 General behavior.adoc[]
include::3.2 Legislation.adoc[]
include::3.3 Groups of properties.adoc[]
include::3.4 Properties.adoc[]
include::3.5 Mock-ups.adoc[]
include::3.6 Data Structures.adoc[]
include::3.7 XML examples and tools.adoc[]
include::3.8 GUI control elements.adoc[]
