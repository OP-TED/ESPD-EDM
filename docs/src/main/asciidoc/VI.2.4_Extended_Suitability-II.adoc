...
image::Selfcontained_Suitability_ServiceContracts_Data_Structure.png[Extended 'Suitability' criterion data structure, alt="Extended 'Suitability' criterion data structure",align="center"]
