...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:./dist/cl/ods/ESPD-Data_Structures-REGULATED-V2.0.1.ods[*REGULATED* ESPD data structures] and link:./dist/cl/ods/ESPD-Data_Structures-SELFCONTAINED-V2.0.1.ods[*SELF-CONTAINED* ESPD data structures] (see folder link:./dist/cl[dist/cl]).
