...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:./dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V02.00.00.ods[*REGULATED* ESPD Criteria Taxonomy] and link:./dist/cl/ods/ESPDRequest-CriteriaTaxonomy-SELFCONTAINED-V02.00.00.ods[*SELF-CONTAINED* ESPD Criteria Taxonomy] (see folder link:./dist/cl[dist/cl]).
