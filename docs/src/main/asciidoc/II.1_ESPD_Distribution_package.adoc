...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:https://github.com/ESPD/ESPD-EDM/tree/2.0.2/docs/src/main/asciidoc/dist/cl/ods/ESPD-Data_Structures-REGULATED-V2.0.2.ods[*REGULATED* ESPD data structures] and link:https://github.com/ESPD/ESPD-EDM/tree/2.0.2/docs/src/main/asciidoc/dist/cl/ods/ESPD-Data_Structures-SELFCONTAINED-V2.0.2.ods[*SELF-CONTAINED* ESPD data structures] (see folder link:https://github.com/ESPD/ESPD-EDM/tree/2.0.2/docs/src/main/asciidoc/dist/cl[dist/cl]).
