...
The ESPD EDM version 2.1.0 has focused on the stabilisation of the previous specification,
notably of the SELF-CONTAINED flavour of the ESPD. No changes have been introduced in the UBL-2.2 XSD schemas beyond the fact that the
