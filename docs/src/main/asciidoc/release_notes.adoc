...
*** Section link:https://espd.github.io/ESPD-EDM/v2.1.0/xml_guide.html#vi-1-alpha-criterion[VI.1 Alpha criterion], to explain the use of the criterion ''Global indication for all selection criteria'',
...
*** Section link:https://espd.github.io/ESPD-EDM/v2.1.0/xml_guide.html#vii-1-reduction-of-candidates[VII.1 Reduction of candidates],
...
*** Section link:https://espd.github.io/ESPD-EDM/v2.1.0/xml_guide.html#vii-2-rules-on-weighting[VII.2 Rules on weighting], on
