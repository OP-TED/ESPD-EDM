...
*** See also how the section ''*** The section ''II.3 UBL-2.2 Documents and libraries'' in the online documentation has been'' has
been adapted
...
CRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.SPECIFIC_YEARLY, see section ''VI.3 Turnovers'')
...
** Criterion #57 (CRITERION.OTHER.EO_DATA.SHELTERED_WORKSHOP)
*** Wrongly indented tag {QUESTION} has been corrected.

** Criterion #58 (CRITERION.OTHER.EO_DATA.REGISTERED_IN_OFFICIAL_LIST)
...
** Criterion #59 (CRITERION.OTHER.EO_DATA.TOGETHER_WITH_OTHERS)
