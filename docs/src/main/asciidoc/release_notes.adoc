...
The ESPD EDM version 2.1.1 focuses on the stabilisation of the previous specification,
...
The list below details exhaustively every change introduced since the publication of the previous release (2.1.1) of the ESPD-EDM:

==== Online documentation

The following sections are new, in the link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html[XML Implementation Guide v2.1.1].

* link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#iv-8-gui-control-elements[IV.8 GUI control elements]: About the sets of data elements (codes
...
** The use of the link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#ontrue-onfalse-codes-for-group-and-subgroup-control[ONTRUE/ONFALSE] codes for GROUP and SUBGROUP control;
** The use of link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#use-of-caption[CAPTION];
** Ideas for link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#business-data-and-gui-decoupling[decoupling the data from the GUI] in future versions of the ESPD-EDM.
See also the link:[examples] provided to illustrate this idea.

* link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#vi-1-alpha-criterion[VI.1 Alpha criterion]: This section describes how the economic operator (EO) has the possibility,
...
* link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#vii-other-aspects-of-participation-and-selection[VII. Other aspects of participation and selection]:
...
* link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#ix-putting-pieces-together[IX Putting pieces together]:
...
** link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/doc/evolution/Annotations_Proposal[Examples]
related to the proposal on _how to decouple the GUI from the data structures_ in future versions of the ESPD-EDM;
** link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/doc/evolution/StaticPropertyUUIDGeneration_Proposal[Examples]
...
** link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/xml[Examples]
...
link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#ii-3-ubl-2-2-documents-and-libraries[II.3 UBL-2.2 Documents and libraries]
...
This has facilitated the automated generation of the link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.1.gc[ESPD-CriteriaTaxonomy]
...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[EOIDType] code list).
...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[EORoleType].
...
ESPD-Request and ESPD-Response v2.1.1 documents (click on the arrow of the combo-box 'Validate as').
...
link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#vi-1-alpha-criterion[VI.1 Alpha Criterion]).

* Exclusion Criteria #7 and #8 (section link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#v-2-contributions[V.2 Contributions])
...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CriteriaTaxonomy-REGULATED-V2.1.1.xlsx[ESPD-CriteriaTaxonomy-REGULATED spread-sheet].
...
link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#vii-6-1-regulated-economic-operator-party[VIII.6.1 Regulated economic operator party]
and link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#vii-6-2-self-contained-economic-operator-party[VIII.6.2 Self-contained economic operator party].
...
* Exclusion Criteria #1 to #6 (section link:https://espd.github.io/ESPD-EDM/v2.1.1/xml_guide.html#v-1-convictions[V.1 Convictions])
...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.xlsx[ESPD-CriteriaTaxonomy-SELFCONTAINED spread-sheet]).
...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.xlsx[spread-sheet]
tab ''SC-References'')
...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.xlsx[Criteria Taxonomy]
