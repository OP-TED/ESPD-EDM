...
Transformation artefacts are now available for the conversion of ESPD Request and Response from version 1.0.3 (see below) and REGULATED ESPD V2.0.2, Request and Response. See chapters "I.5 Forward compatibility" and "Annex II: Conversion from v1.0.3 to v2.0.2" for more details.
