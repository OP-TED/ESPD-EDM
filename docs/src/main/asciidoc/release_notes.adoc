...
The list below details exhaustively every change introduced since the publication of the previous release (2.0.2) of the ESPD-EDM:
...
link:https://github.com/ESPD/ESPD-EDM/blob/master/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CodeLists-V2.0.2.xlsx[ESPD-CodeLists-V2.1.0.xlsx].
...
link:https://github.com/ESPD/ESPD-EDM/blob/master/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CodeLists-V2.0.2.xlsx[MS-Excel] or as an
link:https://github.com/ESPD/ESPD-EDM/blob/master/docs/src/main/asciidoc/dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[ODS file].
...
* Selection Criteria about ''Suitabilities'' are now split into two types of data structure, ''Enrolments'' and ''Service Contracts''.
See tabs ''Suitability-I'' and ''Suitability-II'' of the
...
* Selection Criteria about ''Abilities'' have been split into 5 different data structures:
SC-Abilities_1 (Persons),
SC-Abilities_2 (Facilities),
SC-Abilities_3 (Education),
SC-Abilities_4 (Checks) and
SC-Abilities (5_Man.Staff). See these tabs in the
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.0/docs/src/main/asciidoc/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.xlsx[ESPD-CriteriaTaxonomy-SELFCONTAINED spread-sheet].

* The figure representing the Selection Criteria Taxonomy, in Section VI. Selection Criteria, has been updated to reflect the splitting of the Suitability and Ability data structures.
