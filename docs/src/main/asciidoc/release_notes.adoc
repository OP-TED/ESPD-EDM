...
fully mappable. For more information, please refer to the link:https://espd-edm.github.io/ESPD-EDM/v2.1.0/xml_guide.html#II.3.1_UBL-2.2-TOOP-Requirements[dedicated section] of the online documentation. You can also directly
access to 
