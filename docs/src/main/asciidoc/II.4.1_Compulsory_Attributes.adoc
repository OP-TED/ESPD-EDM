...
UBL-2.2 CCT are defined in the file `CCTS_CCT_SchemaModule-2.2.xsd` (see folders `xsd/common` or `xsdrt/common` in the link:./dist/espd-edm-v2.0.1.zip[distribution package]).
