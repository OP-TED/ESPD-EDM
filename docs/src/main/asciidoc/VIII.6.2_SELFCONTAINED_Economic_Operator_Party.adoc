...
=== VIII.6.2 Self-contained economic operator party
...
One relevant aspect is the *Role* of the economic operator. The ESPD-EDM V2.1.0 defines four different roles for the EO. The information to be provided by each role varies depending on whether the EO is:
