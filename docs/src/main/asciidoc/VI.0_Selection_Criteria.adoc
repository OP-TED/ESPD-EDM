...
[NOTE]
====
The ESPD-EDM V2.1.0 introduces important changes regarding the selection criteria. It provides the contracting authority with much more flexibility to define requirements specific to the procurement procedure. These new features affect specifically the following aspects:
...
* Not all the selection criteria have modified their structures between versions 1.0.2 and 2.1.0.
