...
image:images\Abilities_I_CA_req_mock-up.png['Abilities (I)' CA REQUIREMENT mock-up,width=565,height=328]

_Figure 165. 'Abilities (I)' CA REQUIREMENT edition mock-up_
...
image:images\Special_requierements_check_CA_mock-up.png['Checks' CA REQUIREMENT mock-up,width=524,height=213]

_Figure 172.  Special requierements check CA REQUIREMENT edition mock-up_
