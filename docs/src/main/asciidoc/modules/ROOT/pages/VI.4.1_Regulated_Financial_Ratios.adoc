...
<!-- Criterion:Financial ratio -->
	<cac:TenderingCriterion>
		...
		<cac:Legislation>
			<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">7a182b9e-4c3f-4087-a3ae-9a3791ecd713</cbc:ID>
		...
		<cac:TenderingCriterionPropertyGroup>
			...
			<cac:SubsidiaryTenderingCriterionPropertyGroup>
				...
				<cac:TenderingCriterionProperty>
					<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">a749f03a-abde-4e95-b999-fed640ff96e4</cbc:ID>
					<cbc:Name/>
