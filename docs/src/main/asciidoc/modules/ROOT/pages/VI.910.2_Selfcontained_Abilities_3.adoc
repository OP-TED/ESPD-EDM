...
If you take the data structure spread-sheet and manipulate it as in the figure below you could use the transformation link:https://github.com/ESPD/ESPD-EDM/tree/2.0.2/docs/src/main/asciidoc/dist/xslt/SELFCONTAINED-ESPDRequest-Annotated-V2.0.2.xslt[style-sheet] to obtain the XML snippet shown above with the three sub-groups of pairs 'Year + Number of staff' fields:  
