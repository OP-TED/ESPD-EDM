...
** To specify one of the codes defined by BACH to specify the type of the ratio (see https://www.bach.banque-france.fr/[BACH Banque France], and link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[FinancialRatioType]);
