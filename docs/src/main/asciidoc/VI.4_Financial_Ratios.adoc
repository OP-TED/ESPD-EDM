...
** To specify one of the codes defined by BACH to specify the type of the ratio (see https://www.bach.banque-france.fr/[BACH Banque France], and link:./dist/cl/ods/ESPD-CodeLists-V02.00.00.ods[FinancialRatioType]);
