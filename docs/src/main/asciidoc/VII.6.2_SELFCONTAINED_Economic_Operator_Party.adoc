...
One relevant aspect is the *Role* of the economic operator. The ESPD-EDM V2.0.1 defines four different roles for the EO. The information to be provided by each role varies depending on whether the EO is:
