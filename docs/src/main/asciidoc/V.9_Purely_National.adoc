...
These two requirements are introduced by the new Self-contained ESPD-EDM V2.0.1. Therefore you will see that there is an  essential difference between the Regulated and the Self-contained ESPDs.
