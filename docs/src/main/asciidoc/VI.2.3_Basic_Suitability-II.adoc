...
image::Regulated_Suitability_ServiceContract_Data_Structure.png[Basic 'Suitability' criterion data structure, alt="Basic 'Suitability' criterion data structure",align="center"]
