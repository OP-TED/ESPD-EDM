...
*Rule*: Compulsory use of the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CountryCodeIdentifier].
...
*Rule*: Try to use the name provided in the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CountryCodeIdentifier] and in the language of the user.
