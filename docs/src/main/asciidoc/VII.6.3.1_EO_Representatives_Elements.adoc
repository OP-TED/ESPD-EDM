...
*Rule*: Compulsory use of the Code List link:https://github.com/ESPD/ESPD-EDM/tree/2.1.0/docs/src/main/asciidoc/dist/cl/ods/ESPD-CodeLists-V2.1.0.ods[CountryCodeIdentifier].
...
*Rule*: Try to use the name provided in the Code List link:https://github.com/ESPD/ESPD-EDM/tree/2.1.0/docs/src/main/asciidoc/dist/cl/ods/ESPD-CodeLists-V2.1.0.ods[CountryCodeIdentifier] and in the language of the user.
