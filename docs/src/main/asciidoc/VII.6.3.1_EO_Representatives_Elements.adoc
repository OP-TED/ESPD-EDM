...
*Rule*: Compulsory use of the Code List link:./dist/cl/ods/ESPD-CodeLists-V02.00.00.ods[CountryCodeIdentifier].
...
*Rule*: Try to use the name provided in the Code List link:./dist/cl/ods/ESPD-CodeLists-V02.00.00.ods[CountryCodeIdentifier] and in the language of the user.
