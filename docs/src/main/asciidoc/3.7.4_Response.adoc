...
The economic operator MUST use the code list link:.\code_lists_v1.0.2\PDF\EPROC-ResponseDataType-060716-0951-32-v1.0.2.pdf[ResponseDataType] and make sure that the data provided is of the same type that the
...
----
|OPTIONAL (0..1)
|`*Rule*: The currencyID attribute is MANDATORY (e.g. "EUR"). Compulsory use of the code list link:.\code_lists_v1.0.2\PDF\EPROC-CountryCodeIdentifier-060716-0944-10-v1.0.2.pdf[CountryCodeIdentifier]. BEWARE that amounts can use decimal separators (e.g. 14134,95 but not hundred or thousand separators)`
...
current version of the ESPD Service" of the code list link:.\code_lists_v1.0.2\PDF\EPROC-ResponseDataType-060716-0951-32-v1.0.2.pdf[ResponseDataType]. See also the note
...
|*cev-cac:Evidence*
|One or more references to a source where a documentary proof can be obtained to demostrate that one stated response does actually
...
specified (See code list link:.\code_lists_v1.0.2\PDF\EPROC-ResponseDataType-060716-0951-32-v1.0.2.pdf[ResponseDataType]). 
