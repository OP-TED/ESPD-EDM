...
<cbc:Description>Has the economic operator breached its obligations relating to the payment of taxes, both in the country in which it is established and in Member State of the buyer or contracting entity if other than the country of establishment?</cbc:Description>
...
_<!-- Member State and buyer REQUIREMENT(s). In this case the MS allows a maximum debt of 50 EUR, and additional information is provided for clarification purposes -->_
...
. The MS also allows the buyer the possibility of adding multiple additional textual requirements (in this case the CA uses this to explain that ''Beware that the national Tax Agency won’t permit the existence of a debt, even if minimial, for two consecutive years'').
