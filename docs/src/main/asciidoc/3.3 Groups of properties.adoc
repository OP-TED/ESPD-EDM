...
image:cacTenderingCriterionPropertyGroup_XSD_Schema.png[cac:TenderingCriterionPropertyGroup - XSD Schema global view,width=566,height=305]
...
image:cacSubsidiaryTenderingCriterionGroup_XSD_Schema.png[cac:SubsidiaryTenderingCriterionGroup- XSD Schema,width=566,height=212]
