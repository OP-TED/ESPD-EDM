...
image:Other_economic_financial_requirements_EO mock-up.png['Other economic or financial requirements' EO mock-up,width=587,height=278]
...
image:Other_economic_financial_requirements_criterion_data_structur.png['Other economic or financial requirements' criterion data structure,width=566,height=337]
