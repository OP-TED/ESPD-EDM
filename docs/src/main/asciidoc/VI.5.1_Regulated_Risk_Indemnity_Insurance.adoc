...
<cac:TenderingCriterion>
	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cac:SubsidiaryTenderingCriterionPropertyGroup>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">15a43355-e868-48f4-96de-68645496589a</cbc:ID>
				<cbc:Name/>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">c156d1d4-12ad-4bee-bbde-5092b5f9b336</cbc:ID>
				<cbc:Name/>
