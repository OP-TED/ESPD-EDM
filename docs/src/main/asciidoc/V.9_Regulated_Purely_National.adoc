...
=== V.9 Regulated Purely national criteria
...
<cac:TenderingCriterion>
	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cac:SubsidiaryTenderingCriterionPropertyGroup>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">c043ba71-5f72-4f1f-b2ff-a58daf19902a</cbc:ID>
				<cbc:Name/>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">f12cbae7-0c98-4b9f-81c5-1506ffbc77e6</cbc:ID>
				<cbc:Name/>
