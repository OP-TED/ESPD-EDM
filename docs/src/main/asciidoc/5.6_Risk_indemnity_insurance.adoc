...
image:Risk_indemnity_insurance_CA_requirements_edition_oneLot.png[‘Risk indemnity insurance' Buyer REQUIREMENT(s) edition ,width=544,height=237]
...
image:Risk_indemnity_insurance_CA_requirements_edition_Lots.png[Risk indemnity insurance' Buyer REQUIREMENT(s) edition (Procedure with more than one Lot),width=580,height=590]
...
image:Economic_operator_indemnity_insurance_mock-up.png['Economic operator indemnity insurance’ EO mock-up,width=565,height=368]
...
image:risk_indemnity_insurance_criterion_data_structure.png[risk indemnity insurance' criterion data structure,width=566,height=314]
