...
<cac:TenderingCriterion>
	<cac:TenderingCriterionPropertyGroup>
		<cbc:ID schemeAgencyID="EU-COM-GROW">69c1de17-3256-4920-9d46-1e7da839b279</cbc:ID>
		<cac:TenderingCriterionProperty>
			<cbc:ID schemeAgencyID="EU-COM-GROW">e0036f1c-8129-430b-ab8a-4e1d8703ddeb</cbc:ID>
			...
			<cbc:TypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">CAPTION</cbc:TypeCode> <--3-->
			<cbc:ValueDataTypeCode  listID="ResponseDataType" listAgencyName="EU-COM-GROW" listVersionID="02.00.00">NONE</cbc:ValueDataTypeCode> <--4-->
		</cac:TenderingCriterionProperty>
		<cac:SubsidiaryTenderingCriterionPropertyGroup>
			<cbc:ID schemeAgencyID="EU-COM-GROW">eabd66bb-6899-469b-bb17-80177a2d7f7a</cbc:ID>
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeAgencyID="EU-COM-GROW">f0a38925-a8ee-4753-942d-deca0262ed94</cbc:ID>
				...
				<cbc:ExpectedCode listID="NumberOfLotsCode" listAgencyName="EU-COM-GROW" listVersionID="02.00.00">MAX</cbc:ExpectedCode>
				</cac:TenderingCriterionProperty>
				<cac:TenderingCriterionProperty>
					<cbc:ID schemeAgencyID="EU-COM-GROW">8d899045-1031-467f-a2b4-58ef9b1f719d</cbc:ID>
				...
				<cac:TenderingCriterionProperty>
					<cbc:ID schemeAgencyID="EU-OM-GROW" >8d899045-1031-467f-a2b4-58ef9b1f719d</cbc:ID>
