...
For the ESPD Response, the ESPD-EDM V2.0.1 uses the UBL-2.2 document named `QualificationApplicationResponse.xsd` XSD Schema. This schema can be found under the folder link:./dist/xsdrt/maindoc[dist/xsdrt/maindoc] (or the equivalent documented `xsd` folder).
