...
<cac:TenderingCriterion>
	<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1">77f481ce-ffb6-483f-8e2b-c78db5e68292</cbc:ID>
	<cbc:CriterionTypeCode listID="CriteriaTypeCode" listAgencyID="EU-COM-GROW" listVersionID="2.0.1">CRITERION.SELECTION.ECONOMIC_FINANCIAL_STANDING.TURNOVER.SET_UP</cbc:CriterionTypeCode>
	...
	<cac:SubTenderingCriterion>
		...
		<cac:TenderingCriterionPropertyGroup>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1">8cb78467-9d4c-4990-a41f-0131dc639cd8</cbc:ID>
				<cbc:Name/>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1">b97a9061-409c-4fb7-977e-33e64c1db6a2</cbc:ID>
				<cbc:Name/>
	...
	<cac:Legislation>
		<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1">c753a2c5-59e6-4970-b6eb-27224e96bf76</cbc:ID>
	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cbc:PropertyGroupTypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="2.0.1">ON*</cbc:PropertyGroupTypeCode>
		<cac:TenderingCriterionProperty>
			<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1">23c7e5bb-8ef6-4119-a1e9-183debf7b9c3</cbc:ID>
			<cbc:Name/>
