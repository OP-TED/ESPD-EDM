...
*Rule*: Compulsory use of the UUIDs supplied by e-Certis. See also the spreadsheets link:dist/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.0.2.ods [_Criteria Taxonomy (Regulated ESPD)_] and link:dist/ods/ESPDRequest-CriteriaTaxonomy-SELFCONTAINED-V2.0.2.ods [_Criteria Taxonomy (Self-contained ESPD)_]. 
