...
In the link:.\code_lists_v1.0.2\PDF\EPROC-CriteriaTypeCode-060716-0945-12-v1.0.2.pdf[Criteria Taxonomy] code list these criteria are 
classified as ''CRITERION.OTHER.EO_DATA.*''. The complete list of these criteria is accessible in the table 
link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[ESPD Criteria: Other Criteria] (please have
