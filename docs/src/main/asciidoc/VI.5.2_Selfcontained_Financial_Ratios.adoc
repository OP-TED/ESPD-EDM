...
.Self-contained 'financial ratio' CA mock-up REQUIREMENT(s) edition
image::Selfcontained_Financial_ratio_CA_REQUIREMENT(s)_mockup.png[Self-contained 'financial ratio' CA REQUIREMENT(s) mock-up, alt="Self-contained 'financial ratio' CA REQUIREMENT(s) mock-up", align="center"]
