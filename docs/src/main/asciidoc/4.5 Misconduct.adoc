...
image:Professional_misconduct_criterion mockup_CA_perspective.png['Professional misconduct' criterion mock-up - CA perspective,width=642,height=141]

_Figure 69. 'Professional misconduct' criterion mock-up - contracting authority perspective_
