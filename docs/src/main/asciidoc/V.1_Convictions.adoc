...
<14> UUID supplied by e-Certis. See also the link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.1.1.ods[criteria taxonomy spread-sheet].
<15> Exclusion criteria taxonomy code defined in the link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.1.1.ods[criteria taxonomy spread-sheet].
<16> Compulsory name and description for the criterion as defined in e-Certis. See also link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.1.1.ods[criteria taxonomy spread-sheet]. Beware that UBL-2.2 allows '0..n' description lines!
<17> This property is a caption, a mere 'label'. See Code List link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods['CriterionElementType'] for the complete list of possible options. Beware that when a property is of type `CAPTION` the `cbc:ValueDataType` must be set to `NONE`.
...
<23> The jurisdiction level (or scope) covered by this legislation. You *must* use the text of the description supplied by the link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods[Code List `LegislationType`].
