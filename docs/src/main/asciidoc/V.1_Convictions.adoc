...
<14> UUID supplied by e-Certis. See also the link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-Basic-V2.1.1.ods[criteria taxonomy spread-sheet].
<15> Exclusion criteria taxonomy code defined in the link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-Basic-V2.1.1.ods[criteria taxonomy spread-sheet].
<16> Compulsory name and description for the criterion as defined in e-Certis. See also link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-Basic-V2.1.1.ods[criteria taxonomy spread-sheet]. Beware that UBL-2.2 allows '0..n' description lines!
