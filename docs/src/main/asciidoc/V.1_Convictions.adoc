...
<cac:TenderingCriterion>
	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cbc:PropertyGroupTypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="2.0.2">ON*</cbc:PropertyGroupTypeCode> <--24-->
		<cac:TenderingCriterionProperty>
...
<14> UUID supplied by e-Certis. See also the link:./dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.0.2.ods[criteria taxonomy spread-sheet].
<15> Exclusion criteria taxonomy code defined in the link:./dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.0.2.ods[criteria taxonomy spread-sheet].
<16> Compulsory name and description for the criterion as defined in e-Certis. See also link:./dist/cl/ods/ESPDRequest-CriteriaTaxonomy-REGULATED-V2.0.2.ods[criteria taxonomy spread-sheet]. Beware that UBL-2.2 allows '0..n' description lines!
<17> This property is a caption, a mere 'label'. See Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods['CriterionElementType'] for the complete list of possible options. Beware that when a property is of type `CAPTION` the `cbc:ValueDataType` must be set to `NONE`.
...
<23> The jurisdiction level (or scope) covered by this legislation. You *must* use the text of the description supplied by the link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[Code List `LegislationType`].
