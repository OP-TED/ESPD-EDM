...
=== VI.6.1 Regulated risk indemnity insurance
...
<cac:TenderingCriterion>
	...
	<cac:Legislation>
		<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.0">4004e7e2-9107-4bf1-867c-2f384e4198cf</cbc:ID>
	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cac:TenderingCriterionProperty>
			<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.0">7e1a7918-3f66-42e6-b0fb-26be48aabeb5</cbc:ID>
			<cbc:Name/>
	...
	<cac:TenderingCriterionPropertyGroup>
		...
		<cbc:PropertyGroupTypeCode listID="PropertyGroupType" listAgencyID="EU-COM-GROW" listVersionID="2.1.0">ON*</cbc:PropertyGroupTypeCode>
		<cac:TenderingCriterionProperty>
			<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.0">a5846245-81da-4651-82db-97f1796c4488</cbc:ID>
			<cbc:Name/>
		...
		<cac:SubsidiaryTenderingCriterionPropertyGroup>
			...
			<cac:TenderingCriterionProperty>
				<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.0">2cd3ff94-b65f-4579-a4ed-c76371e16760</cbc:ID>
				<cbc:Name/>
