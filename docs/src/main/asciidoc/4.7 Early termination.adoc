...
image:Early_termination_criterion_mock-up_CA_perspective.png['Early termination' criterion mock-up - CA perspective,width=614,height=156]

_Figure 77. 'Early termination' criterion mock-up - contracting authority perspective_
