...
The structure of this criterion 'other economic or financial requirements' for the *EXTENDED* version is also very particular (distinct from the rest of criteria data structures). Notice the following aspects:
