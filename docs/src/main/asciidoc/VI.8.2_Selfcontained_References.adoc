...
image::Selfcontained_References_CA_REQUIREMENT(s)_mockup.png[Self-contained 'References' CA REQUIREMENT(s) edition mock-up, alt="Self-contained 'References' CA REQUIREMENT(s) edition mock-up", align="center"]
