...
image:Subcontracting proportion_CA_mock-up.png['Subcontracting proportion' buyer mock-up,width=631,height=117]
...
image:Subcontracting proportion_EO_mock-up.png['Subcontracting proportion' EO mock-up,width=613,height=110]
...
image:Subcontracting proportion_criterion_data_structure.png[Subcontracting proportion' criterion data structure,width=566,height=321]
