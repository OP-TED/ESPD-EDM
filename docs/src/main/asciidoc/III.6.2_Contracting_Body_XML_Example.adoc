...
<cac:ContractingParty>
	<cac:Party>
		...
		<cac:PostalAddress>
			...
			<cac:Country><cbc:IdentificationCode listID="CountryCodeIdentifier" listAgencyID="EU-COM-GROW" listVersionID="02.00.00">ES</cbc:IdentificationCode></cac:Country> <--3-->
		</cac:PostalAddress>
		<cac:Contact>
