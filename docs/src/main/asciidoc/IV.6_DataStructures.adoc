...
for this field. This value is most cases a *code* however beware that in this ESPD-EDM specification some code lists
contain codes that *are not* intended to be used as values of codes. *_See the section titled
