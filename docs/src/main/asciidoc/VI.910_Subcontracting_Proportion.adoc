...
<cac:TenderingCriterion>
	...
	<cac:TenderingCriterionPropertyGroup>
		<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.0">575f7550-8a2d-4bad-b9d8-be07ab570076</cbc:ID>
		...
		<cac:TenderingCriterionProperty>
			<cbc:ID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.0">48d527b0-ba49-4fbc-bfd3-3db487c47baf</cbc:ID>
