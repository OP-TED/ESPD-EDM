...
** ESPD-Data_Structures-REGULATED-V2.0.2.xlsx, where the structures of the REGULATED ESPD criteria are defined;

** ESPD-Data_Structures-SELFCONTAINED-V2.0.2.xlsx, where the structures of the SELF-CONTAINE ESPD criteria are defined;  
...
The ESPD-EDM data structures vocabulary is defined in the Code List "link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CriterionElementType]". Her you have the definitions provided therein:
...
* REQUIREMENT: Requirement, remark, rule, restriction or additional information to which the EO needs to conform or comply with; maps to a cac:TenderingCriterionProperty class (one data type must be specified for the value supplied by the contracting authority (CA); see see codes in the Code List "link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[ResponseDataType]") 
...
* QUESTION: A	question that requires an answer (a specific datum) from the EO; maps to a cac:TenderingCriterionProperty class (one, and only one, data type is expected; see codes in the Code List "link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[ResponseDataType]" )
...
** The only possibility in the UBL-2.2 model to distinguish whether a group or a subgroup of criterion properties contains REQUIREMENTs or QUESTIONs is to look into the value of the `cac:TenderingCriterionProperty/cbc:TypeCode`. The list of possible codes are the ones of the above mentioned Code List "link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CriterionElementType]".  
...
** To generate the REGULATED ESPD Request criteria (without the responses, only criteria groups and properties): 
	...
	Example: c:\dist\xslt>Transformer.bat 	..\cl\ods\ESPD-Data_Structures-REGULATED-V2.0.2.ods .\REGULATED-ESPDRequest-Annotated-V2.0.2.xslt ..\xml\MyREGULATED_ESPDRequestCriteria.xml
...
** To generate the SELF-CONTAINED_ESPD Request criteria: 
	...
	Example: c:\dist\xslt>Transformer.bat ..\cl\ods\ESPD-Data_Structures-SELFCONTAINED-V2.0.2.ods	.\SELFCONTAINED-ESPDRequest-Annotated-V2.0.2.xslt ..\xml\MySELFCONTAINED_ESPDRequestCriteria.xml
