...
<7> In this case the code `NOJCN` means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:./dist/cl/CodeLists-V02.00.00[CodeLists-V02.00.00]) in the distribution package.