...
*Rule*: Use it to place here the general Turnover of the EO (for statistical purposes). Compulsory assignment of a value to the attribute currency. The default value should be set to 'EUR'. Compulsory use of the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CurrencyCode].
...
*Rule*: Compulsory use of the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[EORoleType].
...
*Rule*: Software applications should retrieve and reuse the description from the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[EORoleType].
...
*Rule*: The country of the contracting body must always be specified. Compulsory use of the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CountryCodeIdentifier] (ISO 3166-1 2A:2006).
...
*Rule*:  The country of the service provider must always be specified. Compulsory use of the Code List link:./dist/cl/ods/ESPD-CodeLists-V2.0.2.ods[CountryCodeIdentifier] (ISO 3166-1 2A:2006).
