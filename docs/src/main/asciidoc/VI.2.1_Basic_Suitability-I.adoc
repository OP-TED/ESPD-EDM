...
image::Regulated_Suitability_CA_mockup.png[Basic 'Suitability' criterion (CA perspective), alt="Basic 'Suitability' criterion (CA perspective)", align="center"]
...
image::Regulated_Suitability_EO_mockup.png[Basic 'Suitability' criterion (EO perspective), alt="Basic 'Suitability' criterion (EO perspective)", width="800" align="center"]
...
image::Regulated_Suitability_Enrolments_Data_Structure.png[Basic 'Suitability' criterion data structure, alt="Basic 'Suitability' criterion data structure",align="center"]
