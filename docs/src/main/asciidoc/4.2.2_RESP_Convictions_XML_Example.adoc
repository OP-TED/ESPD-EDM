...
----
<1> COM UUID in table link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[ESPD Criteria: Exclusion criteria] 
<2> COM code list link:.\code_lists_v1.0.2\PDF\EPROC-CriteriaTypeCode-060716-0945-12-v1.0.2.pdf[CriteriaTypeCode]
<3> COM UUID in table link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[ESPD Criteria: Exclusion criteria]
<4> COM UUID in table link:.\code_lists_v1.0.2\CriteriaTaxonomy-1.0.2.xlsx[ESPD Criteria: Exclusion criteria]
