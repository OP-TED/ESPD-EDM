...
|BidType|Publications Office of the EU|See link:https://github.com/ESPD/ESPD-EDM/blob/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.1.ods[Data structure] and XML examples for Criterion `CRITERION.OTHER.CA_DATA.LOTS_SUBMISSION` of the *SELF-CONTAINED ESPD Request*
