...
image:Quality_Assurance schemes_environmental_management_stand_CA.png['Quality Assurance schemes and environmental management standards' buyer mock-up,width=468,height=273]
...
image:Quality_Assurance schemes_environmental_management_stand.png[Quality Assurance schemes and environmental management standards' EO mock-up,width=500,height=293]
...
image:Quality Assurance schemes_environmental_data_struc.png['Quality Assurance schemes and environmental management standards' criteria data structure,width=566,height=347]
...
_<!-- No answer is expectedhere from the economic operator, as this is a REQUIREMENT issued by the buyer. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of the requirement issued by the buyer -->_
