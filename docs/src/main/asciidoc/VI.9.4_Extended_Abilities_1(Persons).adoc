...
. The data structure (see the EXTENDED spread-sheet tab link:https://github.com/ESPD/ESPD-EDM/tree/2.1.1/docs/src/main/asciidoc/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-EXTENDED-V2.1.1.ods[SC-Abilities_1]).
