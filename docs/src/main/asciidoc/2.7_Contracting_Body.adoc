...
image:Procurer_identification_mockup.png[Procurer identification,width=600,height=100]
...
image:cacContractingParty_XSD_Schema_global_vision.jpeg[cac:ContractingParty XSD Schema, global vision,width=400,height=286]
