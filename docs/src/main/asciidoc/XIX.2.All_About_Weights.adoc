...
link:https://github.com/ESPD/ESPD-EDM/blob/2.1.0/docs/src/main/asciidoc/dist/xml/Lots-SelfContained-Response_V2.1.0.xml[Weighted_Criteria-Self-Contained-Request-2.1.0.xml]_*
====
