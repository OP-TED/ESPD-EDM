...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:espd="urn:com:grow:espd:2.0.1" xmlns:cac="urn:X-test:UBL:Pre-award:CommonAggregate" xmlns:cbc="urn:X-test:UBL:Pre-award:CommonBasic" xmlns:util="java:java.util.UUID">
	...
	<cbc:CustomizationID schemeAgencyID="CEN-BII" schemeVersionID="2.0.1">urn:www.cenbii.eu:transaction:biitrdm070:ver3.0</cbc:CustomizationID>
	...
	<cbc:ProfileID schemeAgencyID="CEN-BII" schemeVersionID="2.0.1">4.1</cbc:ProfileID>
	...
	<cbc:UUID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1"><xsl:value-of select="util:toString(util:randomUUID())"/></cbc:UUID>
	...
	<cbc:VersionID schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0.1"><xsl:value-of select="'2.0.1'"/></cbc:VersionID>
	...
	<cbc:QualificationApplicationTypeCode listID="QualificationApplicationType"  listAgencyID="EU-COM-GROW" listVersionID="2.0.1"><xsl:value-of select="//./*[./name()='cbc:QualificationApplicationTypeCode']"/></cbc:QualificationApplicationTypeCode>
