...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="createRootElements">
		...
		<cbc:CustomizationID schemeAgencyID="CEN-BII" schemeVersionID="2.1.1"
		...
		<cbc:ProfileID schemeAgencyID="CEN-BII" schemeVersionID="2.1.1">4.1</cbc:ProfileID>
		...
		<cbc:UUID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="EU-COM-GROW"
			schemeVersionID="2.1.1"><xsl:value-of select="util:toString(util:randomUUID())"
			/></cbc:UUID>
		...
		<cbc:VersionID schemeAgencyID="EU-COM-GROW" schemeVersionID="2.1.1"><xsl:value-of
				select="'2.1.1'"/></cbc:VersionID>
