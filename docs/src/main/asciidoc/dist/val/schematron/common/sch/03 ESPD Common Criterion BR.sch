...
-->
	...
	<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="BR-COM-CR">
		...
		<rule context="cac:TenderingCriterion">
			...
			<let name="ElementUUID" value="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.3.xml')//cac:TenderingCriterion[cbc:ID = $currentID] 
				else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3.xml')//cac:TenderingCriterion[cbc:ID = $currentID]"/>
		...
		<rule context="cac:TenderingCriterionPropertyGroup | cac:SubsidiaryTenderingCriterionPropertyGroup">	
			...
			<let name="ElementUUID_SUB" value="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.3.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $currentID] 
				else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $currentID]"/>
			<let name="ParentUUID_SUB" value="$ElementUUID_SUB[parent::*[cbc:ID = $parentID]][1]"/>
			
			<!-- cac:TenderingCriterionPropertyGroup -->
			<let name="ElementUUID_T" value="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.3.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $currentID] 
				else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $currentID]"/>
		...
		<rule context="cac:TenderingCriterionProperty">
			...
			<!-- cac:SubsidiaryTenderingCriterionPropertyGroup -->
			<let name="ElementUUIDSTC" value="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.3.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty 
				else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty"/>
			<let name="ElementUUID_STCExists" value="(count($ElementUUIDSTC) &gt; 0)"/>
			
			<!-- cac:TenderingCriterionPropertyGroup -->
			<let name="ElementUUIDTC" value="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.3.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty 
				else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty"/>		
