...
-->
	...
	<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="BR-RESP-OTHER">
		...
		<rule context="cbc:CustomizationID">
			...
			<assert test="text()='urn:www.cenbii.eu:transaction:biitrdm092:ver3.0'" role="error">For the ESPD customization of UBL ('/cbc:CustomizationID') we use the value “urn:www.cenbii.eu:transaction:biitrdm092:ver3.0”.</assert>
