...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ConfidentialityLevel.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ConfidentialityLevel.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ConfidentialityLevel.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/CriterionElementType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/CriterionElementType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/CriterionElementType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/CurrencyCode.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/CurrencyCode.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/CurrencyCode.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/DocRefContentType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/DocRefContentType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/DocRefContentType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EOIndustryClassificationCode.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EOIndustryClassificationCode.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EOIndustryClassificationCode.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EORoleType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EORoleType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EORoleType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EvaluationMethodType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EvaluationMethodType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/EvaluationMethodType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ProcedyreType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ProcedyreType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ProcedyreType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ProjectType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ProjectType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ProjectType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/PropertyGroupType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/PropertyGroupType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/PropertyGroupType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/QualificationApplicationType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/QualificationApplicationType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/QualificationApplicationType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ResponseDataType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ResponseDataType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ResponseDataType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ServicesProjectSubType.gc'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(false() or not(@listSchemeURI != 'https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ServicesProjectSubType.gc'))">
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Invalid codelist attribute value '<xsl:text/>
                  ...
                  <xsl:text/>/<xsl:text/>
                  <xsl:value-of select="name()"/>
                  <xsl:text/>' must have the following attribute and value: 'listSchemeURI = https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V2.0.3/docs/src/main/asciidoc/dist/cl/gc/ServicesProjectSubType.gc'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
