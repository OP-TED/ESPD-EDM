<?xml version="1.0" encoding="ISO-8859-1"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ccs="urn:x-Crane:ss:Crane-Constraints2Schematron" xmlns:cac="urn:X-test:UBL:Pre-award:CommonAggregate" xmlns:cbc="urn:X-test:UBL:Pre-award:CommonBasic" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:espd-req="urn:X-test:UBL:Pre-award:QualificationApplicationRequest" xmlns:espd-resp="urn:X-test:UBL:Pre-award:QualificationApplicationResponse" xmlns:fn="http://www.w3.org/2005/xpath-functions" version="2.0" exclude-result-prefixes="ccs"><xsl:output indent="yes"/><xsl:template match="/"><xsl:for-each select="document('')"><schema xmlns="http://purl.oclc.org/dsdl/schematron"><pattern id="code-list-values">
...
<rule context="cac:EconomicOperatorParty/cac:EconomicOperatorRole/cbc:RoleCode">
  ...
  <assert><xsl:attribute xmlns="" name="test">( false() or ( (contains(translate('&#127;SCLE&#127;GM&#127;OERON&#127;OENRON&#127;','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('&#127;',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'&#127;')) ) ) ) </xsl:attribute>Invalid value: '<value-of select="."/>' for the element 'cac:EconomicOperatorParty/cac:EconomicOperatorRole/cbc:RoleCode'.</assert>
</rule>
...
<rule context="cac:TenderingCriterionProperty/cbc:ValueDataTypeCode">
  ...
  <assert><xsl:attribute xmlns="" name="test">( false() or ( (contains(translate('&#127;AMOUNT&#127;CODE&#127;CODE_COUNTRY&#127;DATE&#127;DESCRIPTION&#127;EVIDENCE_IDENTIFIER&#127;INDICATOR&#127;PERCENTAGE&#127;PERIOD&#127;QUANTITY_INTEGER&#127;QUANTITY_YEAR&#127;QUANTITY&#127;NONE&#127;IDENTIFIER&#127;URL&#127;MAXIMUM_AMOUNT&#127;MINIMUM_AMOUNT&#127;MAXIMUM_VALUE_NUMERIC&#127;MINIMUM_VALUE_NUMERIC&#127;TRANSLATION_TYPE_CODE&#127;CERTIFICATION_LEVEL_DESCRIPTION&#127;COPY_QUALITY_TYPE_CODE&#127;TIME&#127;','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('&#127;',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'&#127;')) ) ) ) </xsl:attribute>Invalid value: '<value-of select="."/>' for the element 'cac:TenderingCriterionProperty/cbc:ValueDataTypeCode'.</assert>
</rule>
...
<!--{}(BidType)-->
<ccs:Identification xml:id="d3e20">

<Identification>
      <ShortName>BidType</ShortName>
      <LongName xml:lang="en">Bid Type</LongName>
      <Version>1.0</Version>
      ...
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/BidType.gc</LocationUri>
      <Agency>
...
<Identification>
      ...
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/ConfidentialityLevel.gc</LocationUri>
      <Agency>
...
<!--{}(CountryCodeIDs)-->
<ccs:Identification xml:id="d3e28">
...
<!--{}(CriterionElementType)-->
<ccs:Identification xml:id="d3e31">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/CriterionElementType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(CurrencyCodeList)-->
<ccs:Identification xml:id="d3e34">
...
<Identification>
      ...
      <CanonicalUri>http://publications.europa.eu/mdr/authority/index.html</CanonicalUri>
      <CanonicalVersionUri>http://publications.europa.eu/mdr/authority/eprocurement/01/index.html</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/CurrencyCode.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">Publications Office of the EU</LongName>
         <Identifier>EU-COM-OP</Identifier>
      </Agency>
...
<!--{}(DocRefContentType)-->
<ccs:Identification xml:id="d3e37">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/DocRefContentType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(EOIDType)-->
<ccs:Identification xml:id="d3e41">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/EOIDType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(EOIndustryClassificationCode)-->
<ccs:Identification xml:id="d3e44">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/EOIndustryClassificationCode.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(EORoleType)-->
<ccs:Identification xml:id="d3e47">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/EORoleType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(LanguageCodeEU)-->
<ccs:Identification xml:id="d3e50">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/LanguageCodeEU.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(EvaluationMethodType)-->
<ccs:Identification xml:id="d3e54">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/EvaluationMethodType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(FinancialRatioType)-->
<ccs:Identification xml:id="d3e57">

<Identification>
      <ShortName>FinancialRatioType</ShortName>
      <LongName xml:lang="en">FINANCIAL RATIO TYPE</LongName>
      <Version>1.0</Version>
      <CanonicalUri>https://www.bach.banque-france.fr/</CanonicalUri>
      <CanonicalVersionUri>https://www.bach.banque-france.fr/</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/FinancialRatioType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">BACH Banque de France</LongName>
         <Identifier>BACH</Identifier>
      </Agency>
   </Identification></ccs:Identification>
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/PeriodMeasureTypeCodes.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(ProcedureType)-->
<ccs:Identification xml:id="d3e63">
...
<Identification>
      ...
      <CanonicalUri>http://publications.europa.eu/mdr/authority/index.html</CanonicalUri>
      <CanonicalVersionUri>http://publications.europa.eu/mdr/authority/eprocurement/01/index.html</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/ProcedyreType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">Publications Office of the EU</LongName>
         <Identifier>EU-COM-OP</Identifier>
      </Agency>
...
<!--{}(ProfileExecutionID)-->
<ccs:Identification xml:id="d3e67">
...
<!--{}(ProjectType)-->
<ccs:Identification xml:id="d3e69">
...
<Identification>
      ...
      <CanonicalUri>http://publications.europa.eu/mdr/authority/index.html</CanonicalUri>
      <CanonicalVersionUri>http://publications.europa.eu/mdr/authority/eprocurement/01/index.html</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/ProjectType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">Publications Office of the EU</LongName>
         <Identifier>EU-COM-OP</Identifier>
      </Agency>
...
<!--{}(PropertyGroupType)-->
<ccs:Identification xml:id="d3e72">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/PropertyGroupType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(QualificationApplicationType)-->
<ccs:Identification xml:id="d3e75">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/QualificationApplicationType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(ResponseDataType)-->
<ccs:Identification xml:id="d3e79">
...
<Identification>
      ...
      <CanonicalUri>https://github.com/ESPD/ESPD-EDM</CanonicalUri>
      <CanonicalVersionUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/ResponseDataType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">DG GROW (European Commission)</LongName>
         <Identifier>EU-COM-GROW</Identifier>
      </Agency>
...
<!--{}(ServicesProjectSubType)-->
<ccs:Identification xml:id="d3e82">
...
<Identification>
      ...
      <CanonicalUri>http://publications.europa.eu/mdr/authority/index.html</CanonicalUri>
      <CanonicalVersionUri>http://publications.europa.eu/mdr/authority/eprocurement/01/index.html</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/ServicesProjectSubType.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">Publications Office of the EU</LongName>
         <Identifier>EU-COM-OP</Identifier>
      </Agency>
...
<ccs:Identification xml:id="d3e85">
...
<Identification>
      ...
      <CanonicalUri>http://publications.europa.eu/mdr/authority/index.html</CanonicalUri>
      <CanonicalVersionUri>http://publications.europa.eu/mdr/authority/eprocurement/01/index.html</CanonicalVersionUri>
      <LocationUri>https://github.com/ESPD/ESPD-EDM/tree/ESPD-EDM-V02.00.00/docs/src/main/asciidoc/dist/cl/gc/TechnicalCapabilityTypeCode.gc</LocationUri>
      <Agency>
         <LongName xml:lang="en">Publications Office of the EU</LongName>
         <Identifier>EU-COM-OP</Identifier>
      </Agency>
...
<!--{}(WeightingType)-->
<ccs:Identification xml:id="d3e87">
