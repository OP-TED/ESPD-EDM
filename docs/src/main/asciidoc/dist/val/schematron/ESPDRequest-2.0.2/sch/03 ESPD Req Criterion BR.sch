...
-->
	...
	<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="BR-REQ-CR">
		...
		<rule context="espd:QualificationApplicationRequest">
			...
			<let name="ElementUUID_Exclusion" value="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.3.xml')//cac:TenderingCriterion[starts-with(cbc:CriterionTypeCode, 'CRITERION.EXCLUSION.')] 
				else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3.xml')//cac:TenderingCriterion[starts-with(cbc:CriterionTypeCode, 'CRITERION.EXCLUSION.')]"/>
